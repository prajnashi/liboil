...
#define oil_copy_u8 ((void (*)(uint8_t * dest, uint8_t * src, int n)) \
	oil_function_class_ptr_copy_u8->func)
...
#define oil_md5 ((void (*)(uint32_t * state, uint32_t * src)) \
	oil_function_class_ptr_md5->func)
